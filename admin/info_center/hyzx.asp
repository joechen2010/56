...
<% if request("action")="del" then
   page=request("page")
     ...
     if instr(idlist,",")>0 then
		...
		next
		response.Redirect "hyzx.asp?page="&page&""
     		else
...
'if  Request.QueryString("del")<>"" then
   'delsql="delete from hyzx where id="&Request.QueryString("del")
  ' conn.execute(delsql)
'end if
'delete end---------------
%>
...
<div align="center"> 
  <table width="96%" border="0" align="center" cellspacing="0" class="px14">
    ...
    <tr>
      <td align="center" bgcolor="#6699ff" height="30"><font color="#FFFFFF"> 货运专线管理</font></td>
    </tr>
  </table>
   <br>
   <form method="post" name="myform" action="hyzx.asp">
   <% 
	  set rs=Server.Createobject("ADODB.Recordset")
    sql="select  * from zx_info a,qyml b where infotype='货运专线' and a.gsid=b.user order by infoid desc"
  ...
  <table width="96%" border="0" cellspacing="1">
    ...
    <td width="178" height="25" bgcolor="#e1eefd" align="center">途经(中转)城市</td>
    <td width="173" height="25" bgcolor="#e1eefd" align="center">公司名称</td>
    <td width="147" height="25" bgcolor="#e1eefd" align="center">发布日期</td>
	<td width="151" height="25" bgcolor="#e1eefd" align="center">审核</td>
