...
<div align="center"> 
  <table width="96%" border="0" align="center" cellspacing="0" class="px14">
    ...
    <tr>
      <td align="center" bgcolor="#6699ff" height="30"><font color="#FFFFFF"> 招聘求职管理</font></td>
    </tr>
  </table>
   <br>
  ...
  <table width="96%" border="0" cellspacing="1">
    <tr bgcolor="#CCCCCC"> 
    <td width="197" height="25" bgcolor="#e1eefd" align="center">信息类型</td>
    <td width="123" height="25" bgcolor="#e1eefd" align="center">招聘职位/求职人</td>
	<td width="110" height="25" bgcolor="#e1eefd" align="center">招聘单位</td>
    <td width="109" height="25" bgcolor="#e1eefd" align="center">所在省市</td>
	<td width="245" height="25" bgcolor="#e1eefd" align="center">发布时间</td>
