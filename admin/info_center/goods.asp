...
<% if request("action")="del" then
   page=request("page")
     ...
     if instr(idlist,",")>0 then
		...
		next
		response.Redirect "goods.asp?page="&page&""
     		else
...
<div align="center"> 
  <table width="96%" border="0" align="center" cellspacing="0" class="px14">
    ...
    <tr>
      <td align="center" bgcolor="#6699ff" height="30"><font color="#FFFFFF"> 货源信息管理</font></td>
    </tr>
  </table>
   <br>
   <form method="post" name="myform" action="goods.asp">
   <% 
	  set rs=Server.Createobject("ADODB.Recordset")
    sql="select  * from info2 where infotype='货源信息' order by addtime desc"
  ...
  <table width="96%" border="0" cellspacing="1">
    <tr bgcolor="#CCCCCC"> 
    <td width="204" height="25" bgcolor="#e1eefd" align="center">出发地</td>
    <td width="158" height="25" bgcolor="#e1eefd" align="center">目的地</td>
    <td width="178" height="25" bgcolor="#e1eefd" align="center">类型</td>
    <td width="135" height="25" bgcolor="#e1eefd" align="center">重量(吨)</td>
    <td width="153" height="25" bgcolor="#e1eefd" align="center">发布日期</td>
	<td width="153" height="25" bgcolor="#e1eefd" align="center">审核</td>
    <td width="123"  bgcolor="#e1eefd" align="center">删除</td>
    </tr>
