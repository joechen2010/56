...
<% if request("action")="del" then
   page=request("page")
     ...
     if instr(idlist,",")>0 then
		...
		next
		response.Redirect "file.asp?page="&page&""
     		else
...
sub deleteannounce(id)
    ...
    sql_del="delete from file_info where infoid="&cstr(id)
    conn.execute sql_del
End sub	
if request("pass")="0" then
  conn.execute("update file_info set pass=false where infoid="&request("id"))
  response.Redirect "?page="&request("page")&""
  elseif request("pass")="1" then
   conn.execute("update file_info set pass=true where infoid="&request("id"))
  response.Redirect "?page="&request("page")&"" 
end if
'delete -----------
'if  Request.QueryString("del")<>"" then
   'delsql="delete from file where id="&Request.QueryString("del")
  ' conn.execute(delsql)
'end if
'delete end---------------
%>
...
<div align="center"> 
  <table width="96%" border="0" align="center" cellspacing="0" class="px14">
    ...
    <tr>
      <td align="center" bgcolor="#6699ff" height="30"><font color="#FFFFFF"> 车辆档案管理</font></td>
    </tr>
  </table>
   <br>
   <form method="post" name="myform" action="file.asp">
   <% 
	  set rs=Server.Createobject("ADODB.Recordset")
    sql="select * from file_info a,qyml b where a.gsid=b.user order by infoid desc"
  ...
  <table width="96%" border="0" cellspacing="1">
    <tr bgcolor="#CCCCCC"> 
    <td width="218" height="25" bgcolor="#e1eefd" align="center">车牌号</td>
    <td width="238" height="25" bgcolor="#e1eefd" align="center">车籍</td>
    <td width="167" height="25" bgcolor="#e1eefd" align="center">车主</td>
	<td width="167" height="25" bgcolor="#e1eefd" align="center">车型</td>
    <td width="184" height="25" bgcolor="#e1eefd" align="center">发布日期</td>
	<td width="157" height="25" bgcolor="#e1eefd" align="center">审核</td>
    <td width="147"  bgcolor="#e1eefd" align="center">删除</td>
    </tr>
	 <% for ipage=1 to rs.pagesize%>
   <tr bgcolor="#F6F6F6"  onMouseOut="mOut(this,'#F6F6F6');" onMouseOver="mOvr(this,'#EBFFBB');"> 
    <td align="Right">
	<a href="javascript:openwindow('../../cheliang/detail.asp?infoid=<%=rs("InfoID")%>',500,400)">
	<%=rs("carnum")%></a></td>
