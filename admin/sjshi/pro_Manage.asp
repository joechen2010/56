...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%">
<form method=Post action="pro_Manage.asp">
<%
      		...
      		if (currentpage-1)*MaxPerPage>totalput then
       		...
       		if currentPage=1 then
           		'showpage totalput,MaxPerPage,"News_Manage.asp"
            		showContent
            		showpage totalput,MaxPerPage,"pro_manage.asp"
       		else
          		if (currentPage-1)*MaxPerPage<totalPut then
      ...
      <br>
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
          <tr class="title" height="22"> 
            ...
            <td width="138" align="center">姓名</td>
            <td width="280" align="center">小图片地址</td>
            <td width="392" align="center">大图片地址</td>
          </tr>
          <%do while not rs.eof%>
          <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'"> 
            ...
            <td width="75" align="center"><%=rs("id")%></td>
            <td width="138"><%=rs("sjname")%></td>
            <td align="center"><%=rs("smallpic")%></td>
            <td align="center"><%=rs("bigpic")%></td>
          </tr>
          <%
	i=i+1
