...
data = '&agt=' + escape(agt) + '&r=' + escape(document.referrer) +  '&aN=' + escape(navigator.appName) + '&lg=' + escape(navigator.systemLanguage) + '&OS=' + escape(navigator.platform) + '&aV=' + escape(navigator.appVersion) + '&ntime=0.61764900 1155338713';
...
document.write('<a href="http://vip3.1tong.com.cn/link/pview.php?id=147" target=_blank title="一统天下">[一统天下]<img border=0  hspace=0 vspace=0 src="http://vip3.1tong.com.cn/link/count.htm?id=147'+ data +'" height=0 width=0></a>');
