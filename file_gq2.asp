<table width="778" border="0" align="center" cellspacing="0">
  <tr> 
	...
	border="0">
		   ...
		   sql="select top 5 * from file_info a,qyml b where a.gsid=b.user and (b.province='"&fz&"' or b.city='"&fz&"') order by infoid desc"
	...
	border="0">
            ...
            <%set rs_gq=server.CreateObject("adodb.recordset")
		  rs_gq.open "select top 5 * from gq_info where province='"&fz&"' or city='"&fz&"' order by infoid asc",conn,1,1
		  %>
...
<table width="778" border="0" align="center" cellspacing="0">
  <tr> 
	...
	border="0">
		   ...
		   rs_z.open "select top 5 * from zp_info where infotype='招聘信息' and (province='"&fz&"' or city='"&fz&"') order by infoid desc",conn,1,1
		  %>
            <table border="0" cellspacing="1" cellpadding="4" bgcolor="#006666" width="100%">
              ...
              <tr bgcolor="#009999"> 
                ...
                <td align="center" valign="top"><font color="#FFFFFF">发布日期</font></td>
              </tr>
		  ...
		  %>
                ...
                <td align="center" valign="top">
				<%=year(rs_z("addtime"))%>-<%=month(rs_z("addtime"))%>-<%=day(rs_z("addtime"))%></td>
              </tr>
              <%rs_z.movenext
			    loop
				rs_z.close
	...
	border="0">
		    ...
		    rs_q.open "select top 5 * from zp_info where infotype='求职信息' and (province='"&fz&"' or city='"&fz&"') order by infoid desc",conn,1,1
		  %>
            <table border="0" cellspacing="1" cellpadding="4" width="100%" bgcolor="#006699">
              ...
              <tr> 
                ...
                <td valign="top" align="center"><font color="#FFFFFF">发布日期</font></td>
              </tr>
