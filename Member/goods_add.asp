      ...
      <table width="98%"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 发布货源信息</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">发布货源信息</font></div>
                      </td>
  ...
  <form method="post" action="goods_save.asp" name="Form1" onSubmit="javascript:return check(this);">
		...
		<option value="捎带货">捎带货</option>
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        ...
                        <td width="81%" valign="top" height="22"> <font color="#FF6600">
                          <input name=carload id=carload maxlength="3">
                          &nbsp;
                          </font>吨</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        ...
                        <td width="81%" valign="top" height="22" bgcolor="#EDF6FF"><font color="#FF6600">
                          <input name=carLong id=carlong maxlength="3">
                          &nbsp;
                          </font>米</td>
                      </tr>
                      <tr bgcolor="#EDF6FF">
