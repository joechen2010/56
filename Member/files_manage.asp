...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt;<font color="#FFFFFF">已登记的车辆档案</font></td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">已登记的车辆档案</font></div>
                      </td>
              ...
              <tr>
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#FF6500">
                    <tr bgcolor="#FFDBBF"> 
                      <td width="81" bgcolor="#FFDBBF" align="center">车牌号</td>
                      <td bgcolor="#FFCEAA" align="center" width="62">品牌</td>
                      <td width="70" bgcolor="#FFCEAA" align="center">车型</td>
                      <td width="53" bgcolor="#FFCEAA" align="center">吨位</td>
                      <td width="57" bgcolor="#FFCEAA" align="center">登记时间</td>
...
strUnit="个信息"
    sql="select * from file_info where gsid='"+session("user")+"' order  by AddTime desc"
	sfilename="files_Manage.asp"
...
%>
                    <%do while not rs.eof%>
                    <tr bgcolor="#FFDBBF"> 
                      <td bgcolor="#FFDBBF" align="center"><%=rs("carnum")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("carpp")%></td>
                      ...
                      <td bgcolor="#FFCEAA" align="center"><a href="files_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="files_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
