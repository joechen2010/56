...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 已发布的库房供求信息</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">已发布库房供求信息</font></div>
                      </td>
                ...
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#FF6500">
                    <tr bgcolor="#FFDBBF"> 
                      ...
                      <td bgcolor="#FFCEAA" align="center" width="62">库房类型</td>
                      <td width="70" bgcolor="#FFCEAA" align="center">仓库地点</td>
                      <td width="53" bgcolor="#FFCEAA" align="center">价格</td>
...
strUnit="个信息"
    sql="select * from kf_info where gsid='"+session("user")+"' order  by AddTime desc"
	sfilename="kf_Manage.asp"
...
%>
                    ...
                    <tr bgcolor="#FFDBBF"> 
                      ...
                      <td bgcolor="#FFCEAA" align="center"><%=rs("kftype")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("city")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("prices")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("addtime")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("Hits")%></td>
                      <td bgcolor="#FFCEAA" align="center"><a href="kf_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="kf_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
