...
%>
                    ...
                    <tr bgcolor="#FFDBBF"> 
					  ...
					  <a href="zzz_Edit.asp?ID=<%=rs("ID")%>&city=<%=request("city")%>&infoid=<%=request("infoid")%>">修改</a>&nbsp;<a href="zzz_Del.asp?id=<%=rs("ID")%>&city=<%=request("city")%>&infoid=<%=request("infoid")%>&action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
...
<%end sub%>
              ...
              <tr>
                <td align="center" valign="top">
				 <%if request("action")="" then%>
				  <form method="post" action="zzz_add.asp?action=add" name="Form2">
  ...
  <form method="post" action="zzz_save.asp?city=<%=request("city")%>&infoid=<%=request("infoid")%>" name="Form1" onSubmit="javascript:return check(this);">
