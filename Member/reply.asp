	  ...
	  <table width="534"  border="0" cellspacing="0" cellpadding="6">
        <tr> 
          <td align="left"><img src="images/icon02.gif" align="absmiddle" width="27" height="19"> 
            <strong> <font color="#cc0000"> yishang </font> </strong>，欢迎您回来！</td>
        </tr>
      </table>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">回复留言</font></div>
                      </td>
...
><%=rs("content")%></textarea>
                      ...
                      <TR ALIGN="CENTER" bgcolor="#EDF6FF"> 
                        <TD COLSPAN="2"> 
                          <input type="hidden" name="F_User" value="<%=rs("T_User")%>">
                          <input type="hidden" name="T_User" value="<%=rs("F_User")%>">
                          <input type="hidden" name="T_Name" value="<%=rs("F_Name")%>">
                          <input type="hidden" name="T_Company" value="<%=rs("F_Company")%>">
                          <input type="hidden" name="T_Email" value="<%=rs("F_Email")%>">
