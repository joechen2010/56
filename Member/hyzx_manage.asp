...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 已发布的货运专线</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">已发布的货运专线</font></div>
                      </td>
                ...
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#FF6500">
                    <tr bgcolor="#FFDBBF"> 
                      ...
                      <td align="center" bgcolor="#FFCEAA">途经城市</td>
                      <td align="center" bgcolor="#FFCEAA">中转站及报价</td>
...
strUnit="个信息"
    sql="select * from zx_info where gsid='"+session("user")+"' and infotype='货运专线' order  by AddTime desc"
...
%>
                    ...
                    <tr bgcolor="#FFDBBF"> 
                      ...
                      <td align="center" bgcolor="#FFCEAA">
					  <a href="zzz_add.asp?infoid=<%=rs("infoid")%>&city=<%=rs("city")%>">中转站及报价</a>
					  </td>
                      <td bgcolor="#FFCEAA" align="center"><a href="hyzx_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="hyzx_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
