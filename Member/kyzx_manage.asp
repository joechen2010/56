...
strUnit="个信息"
    sql="select * from zx_info where gsid='"+session("user")+"' and infotype='客运专线' order  by AddTime desc"
	sfilename="kyzx_Manage.asp"
...
%>
                    ...
                    <tr bgcolor="#FFDBBF"> 
                      ...
                      <td align="center" bgcolor="#FFCEAA">
					  <a href="zzz_add2.asp?infoid=<%=rs("infoid")%>&city=<%=rs("city")%>">中转站及报价</a></td>
                      <td bgcolor="#FFCEAA" align="center"><a href="kyzx_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="kyzx_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
