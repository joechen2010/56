      ...
      <table width="98%"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 发布招聘求职信息</td>
        ...
        <tr>
          <td align="center" valign="top">
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">发布招聘求职信息</font></div>
                      </td>
            ...
            <table width="98%"  border="0" cellspacing="0" cellpadding="5">
              <tr>
                <td align="center"><a href="?action=招聘">发布招聘信息</a><br>
                  <a href="?action=求职">发布求职信息</a></td>
              </tr>
            </table>
			         <%end if%>	
					  <%end if%>
					  <%if request("action")="招聘" then%>					   
  <form method="post" action="zp_save.asp?action=招聘" name="Form1" onSubmit="javascript:return check(this);">
                    ...
                    <table border="0" style="border-collapse: collapse" width="100%" id="AutoNumber1" bordercolorlight="#FFFFFF" cellpadding="5" bordercolordark="#FFFFFF" height="121" cellspacing="1" bgcolor="#B1D4F2">
                      <tr> 
                        <td colspan="2" height="22" background="images/title_bg.gif"><font color="#FFFFFF">发布招聘求职信息</font></td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">所在省市:</td>
            ...
            setup();
                        ...
                        <td width="19%" height="22">招聘职位:</td>
                        <td width="81%" valign="top" height="22"> <font color="#FF6600"> 
                          <input name="job" type="text" maxlength="15">
                          </font></td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">提供月薪: </td>
                        <td width="81%" valign="top" height="22"><font color="#FF6600">
                          <input name="money" type="text" maxlength="5">
                          </font> </td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">基本要求:</td>
		...
		<option value="全职">全职</option>
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">联系方式:</td>
                        <td width="81%" valign="top" height="22"> <font color="#FF6600">
                          <input type="text" name=contact value="<%=session("Phone")%>" readonly>
                          </font></td>
                      </tr>
                      <tr bgcolor="#EDF6FF">
		  ...
		  <%if request("action")="求职" then%>					   
  <form method="post" action="zp_save.asp?action=求职" name="Form1" onSubmit="javascript:return check(this);">
            ...
            setup();
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">求职职位:</td>
                        <td width="81%" valign="top" height="22"> <font color="#FF6600"> 
                          <input name="job" type="text" maxlength="15">
                          </font>*</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">期望月薪: </td>
                        <td width="81%" valign="top" height="22"><font color="#FF6600">
                          <input name="money" type="text" maxlength="5">
                          </font>*</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">基本情况:</td>
                        <td width="81%" valign="top" height="22"> 
                        <select name="jobtype">
		<option value="兼职">兼职</option>
		<option value="全职">全职</option>
