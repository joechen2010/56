...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 已发布的搬运吊装信息</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">已发布的信息</font></div>
                      </td>
              ...
              <tr>
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#FF6500">
                    <tr bgcolor="#FFDBBF"> 
                      <td align="center" bgcolor="#FFDBBF">信息标题</td>
                      <td width="83" align="center" bgcolor="#FFCEAA">所在地点</td>
...
strUnit="个信息"
    sql="select * from banyun_info where gsid='"+session("user")+"' order  by AddTime desc"
...
%>
                    <%do while not rs.eof%>
                    <tr bgcolor="#FFDBBF"> 
                      <td align="center" bgcolor="#FFDBBF"><%=rs("title")%></td>
                      ...
                      <td bgcolor="#FFCEAA" align="center"><a href="banyun_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="banyun_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
