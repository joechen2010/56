...
set rs=conn.execute("select * from kf_info where infoID="&infoID)
...
if (document.Form1.mji.value =="") 
{ 
alert("面积不能为空"); 
document.Form1.mji.focus(); 
return (false); 
}
if (document.Form1.prices.value =="") 
{ 
alert("价格不能为空"); 
...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 修改库房供求信息</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">修改库房供求信息</font></div>
                      </td>
  ...
  <form method="POST" action="kf_Edit_save.asp" name="Form1" onSubmit="javascript:return check(this);">
	...
	<option value="购买">购买</option>						
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">库房类型：</td>
                        <td width="81%" valign="top" height="22"> <font color="#FF6600"> 
						<select name="kftype" id="cartype">
						<option selected value="<%=rs("kftype")%>"><%=rs("kftype")%></option>
	...
	<option value="露天">露天</option>						
            ...
            setup();
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">仓储条件:</td>
                        <td width="81%" valign="top" height="22"> 
                        <input name="tj1" type="checkbox" value="有铁路专线" <%if rs("tj1")<>"" then response.Write "checked" end if%>>有无铁路专线
						<input name="tj2" type="checkbox" value="有配送能力" <%if rs("tj2")<>"" then response.Write "checked" end if%>>有无配送能力 
						<input name="tj3" type="checkbox" value="大件装卸能力" <%if rs("tj3")<>"" then response.Write "checked" end if%>>大件装卸能力
						</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">面积：</td>
                        <td width="81%" valign="top" height="22"> <font color="#FF6600">
                          <input type="text" name=mji value="<%=rs("mji")%>">
                          </font>平米</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">价格：</td>
                        <td width="81%" valign="top" height="22" bgcolor="#EDF6FF"><font color="#FF6600">
                          <input type="text" name="prices" value="<%=rs("prices")%>">
                          </font>元（元／年）</td>
                      </tr>
                      <tr bgcolor="#EDF6FF">
