...
set rs=conn.execute("select * from banyun_info where infoID="&infoID)
...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 修改搬运吊装信息</td>
  ...
  <form method="POST" action="banyun_Edit_save.asp" name="Form1" onSubmit="javascript:return check(this);">
