...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 商铺招牌设置</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">上传企业LOGO</font></div>
                      </td>
            ...
            <table width="534"  border="0" cellpadding="5" cellspacing="1" bgcolor="1E3E93">
              <tr>
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table border="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="AutoNumber2" bordercolorlight="#FFEEB3" cellpadding="5" bordercolordark="#FFEEB3" height="166" bgcolor="#B1D4F2">
                    <tr bgcolor="#EDF6FF"> 
                      <TD height=32 width=135 align="center">上传图片:</TD>
                      <td height="32" width="443"> 
                        <form name="form" method="post" action="logoupfile.asp" enctype="multipart/form-data" >
                    <input type="hidden" name="filepath" value="logo/"> <input type="hidden" name="act" value="upload">
                          选择图片： 
                          <input type="file" name="file1" size="40" class="box"> 
<input type="submit" name="Submit" class="btsub" value="上传"> </form></td></tr> 
                    <tr bgcolor="#EDF6FF"> 
...
<tr> <td width="100%"> <%if rs("logo")<>"" then %><img src="<%=rs("logo")%>"><%else%><img src="images/nopicture.gif">
