...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 我发出的留言</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">我发出的留言</font></div>
                      </td>
                                      ...
                                      <td valign=top height="122" width="100%"> 
                                        <div align="center"> 
                                          <table border=0 cellpadding=5 cellspacing=1 width="100%" style="border-collapse: collapse" bgcolor="#B1D4F2">
                                            <tr align="center"> 
                                              <td width="35%" height="19" background="images/title_bg_2.gif">标题</td>
                                              <td width="12%" height="19" background="images/title_bg_2.gif">收件人</td>
                                              <td width="39%" height="19" background="images/title_bg_2.gif">发送时间</td>
                                              <td width="14%" height="19" background="images/title_bg_2.gif">操作</td>
                                            </tr>
                                            <%do while not rs.eof%>
                                            <tr> 
                                              ...
                                              <td height="19" bgcolor="#FFFFF9" width="14%" align="center"><a href="resend.asp?id=<%=rs("id")%>">重发</a> 
