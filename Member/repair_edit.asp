...
set rs=conn.execute("select * from repair_info where infoID="&infoID)
...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 修改修理配件信息</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">修改信息</font></div>
                      </td>
  ...
  <form method="POST" action="repair_Edit_save.asp" name="Form1" onSubmit="javascript:return check(this);">
