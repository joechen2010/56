              ...
              <tr>
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#FF6500">
                    <tr bgcolor="#FFDBBF"> 
                      <td width="115" bgcolor="#FFDBBF" align="center">型号</td>
                      <td bgcolor="#FFCEAA" align="center" width="50">品牌</td>
                      <td width="80" bgcolor="#FFCEAA" align="center">单价（元）</td>
                      <td width="60" bgcolor="#FFCEAA" align="center">数量</td>
                      <td width="65" bgcolor="#FFCEAA" align="center">发布时间</td>
                      <td width="40" bgcolor="#FFCEAA" align="center">查看</td>
                      <td width="110" bgcolor="#FFCEAA" align="center">操作</td>
                    </tr>
                    <%
    const MaxPerPage=15
   	dim totalPut   
...
strUnit="个产品"
    sql="select * from spzs where gsid='"+session("user")+"' order by AddTime desc"
...
%>
                    <%do while not rs.eof%>
                    <tr bgcolor="#FFDBBF"> 
                      <td bgcolor="#FFDBBF" align="center"><%=rs("BearinNo")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("Brand")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("Price")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("Num")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("addtime")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("Hits")%></td>
                      <td bgcolor="#FFCEAA" align="center"><a href="Pro_Edit.asp?ProID=<%=rs("ProID")%>">修改</a> <a href="Pro_Del.asp?ProID=<%=rs("ProID")%>&Action=Update">更新</a> <a href="Pro_Del.asp?ProID=<%=rs("ProID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
