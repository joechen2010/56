...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 站外采购信息</td>
                ...
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#B1D4F2">
                    <tr bgcolor="#3399FF"> 
                      ...
                      <td align="center" width="200"><font color="#FFFFFF">标题</font></td>
...
strUnit="条信息"
    sql="select * from Offer Order by UpdateTime desc"
	sfilename="order.asp"
...
%>
                    <%do while not rs.eof%>
                    <tr bgcolor="#EDF6FF"> 
                      <td align="center"><%=rs("OfferType")%></td>
                      <td><%=rs("Subject")%></td>
                      <td align="center"><%=rs("UpdateTime")%></td>
                      <td align="center"><%=rs("Hits")%></td>
                      <td align="center"><a href='../trade/Offer_view.asp?OfferID=<%=rs("OfferID")%>' target="_blank">查看信息</a></td>
                    </tr>
                    <% 
i=i+1
