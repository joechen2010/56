...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 已发布的招牌求职</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">已发布的招牌求职</font></div>
                      </td>
              ...
              <tr>
                <td valign="top" bgcolor="#FFFFFF"> 
                  <table width="520" border="0" cellpadding="4" cellspacing="1" bgcolor="#FF6500">
                    <tr bgcolor="#FFDBBF"> 
                      <td width="81" bgcolor="#FFDBBF" align="center">招聘职位</td>
                      <td bgcolor="#FFCEAA" align="center" width="62">提供月薪</td>
                      <td align="center" bgcolor="#FFCEAA">职位说明</td>
...
strUnit="个信息"
    sql="select * from zp_info where gsid='"+session("user")+"' and (infotype='招聘信息' or infotype='求职信息') order by AddTime desc"
	sfilename="zp_Manage.asp"
...
%>
                    <%do while not rs.eof%>
                    <tr bgcolor="#FFDBBF"> 
                      <td bgcolor="#FFDBBF" align="center"><%=rs("job")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("money")%></td>
                      <td align="center" bgcolor="#FFCEAA"><%=rs("content")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("addtime")%></td>
                      <td bgcolor="#FFCEAA" align="center"><%=rs("Hits")%></td>
                      <td bgcolor="#FFCEAA" align="center"><a href="zp_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="zp_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
