      ...
      <table width="98%"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 发布库房供求信息</td>
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">发布库房供求信息</font></div>
                      </td>
            ...
            <table width="98%"  border="0" cellpadding="5" cellspacing="1" bgcolor="1E3E93">
			  ...
			  <table width="100%"  border="0">
                        ...
                        <div id="TipAll" > <font color="#FF0000">注：请不要发布重复信息，谢谢合作&nbsp;&nbsp;&nbsp;&nbsp; 
						   ...
						   %>
  <form method="post" action="kf_save.asp" name="Form1" onSubmit="javascript:return check(this);">
	...
	<option value="露天">露天</option>							
            ...
            setup();
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        ...
                        <input name="tj1" type="checkbox" value="有铁路专线">有无铁路专线
						<input name="tj2" type="checkbox" value="有配送能力 ">有无配送能力 
						<input name="tj3" type="checkbox" value="大件装卸能力">大件装卸能力
						</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">面积：</td>
                        <td width="81%" valign="top" height="22"> <font color="#FF6600">
                          <input name="mji" type="text" maxlength="4">
                          </font>平米</td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">价格：</td>
                        <td width="81%" valign="top" height="22" bgcolor="#EDF6FF"><font color="#FF6600">
                          <input name="prices" type="text" maxlength="4">
                          </font>元（元／年）</td>
                      </tr>
                      <tr bgcolor="#EDF6FF">
