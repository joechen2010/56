...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 已发布的修理配件信息</td>
...
strUnit="个信息"
    sql="select * from repair_info where gsid='"+session("user")+"' order  by AddTime desc"
...
%>
                    ...
                    <tr bgcolor="#FFDBBF"> 
                      ...
                      <td bgcolor="#FFCEAA" align="center"><a href="repair_Edit.asp?infoID=<%=rs("infoID")%>">修改</a>&nbsp;<a href="repair_Del.asp?infoid=<%=rs("infoID")%>&Action=Del" Onclick="return ConfirmDel();" >删除</a></td>
                    </tr>
                    <% 
i=i+1
