...
set rs=conn.execute("select * from zp_info where infoID="&infoID)
...
<table width="94%"  border="0" cellspacing="0" cellpadding="3">
      <tr>
          <td width="83%" height="38" align="left" id="pos"><img src="images/icon03.gif" width="15" height="11"> 
            <a href="http://www.cx56w.com">诚信物流网</a> &gt; 修改招聘求职</td>
  ...
  <form method="POST" action="zp_Edit_save.asp" name="Form1" onSubmit="javascript:return check(this);">
                    ...
                    <table border="0" style="border-collapse: collapse" width="100%" id="AutoNumber1" bordercolorlight="#FFFFFF" cellpadding="5" bordercolordark="#FFFFFF" height="121" cellspacing="1" bgcolor="#B1D4F2">
                      <tr> 
                        <td colspan="2" height="22" background="images/title_bg.gif"><font color="#FFFFFF">发布招聘求职</font></td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
            ...
            setup();
                        ...
                        <td width="81%" valign="top" height="22"> <font color="#FF6600"> 
                          <input id=BearinNo name="job" value="<%=rs("job")%>">
                          </font></td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        <td width="19%" height="22">提供月薪: </td>
                        <td width="81%" valign="top" height="22"><font color="#FF6600">
                          <input id=Brand name="money" value="<%=rs("money")%>">
                          </font> </td>
                      </tr>
                      <tr bgcolor="#EDF6FF"> 
                        ...
                        <select name="cartype" id="cartype">
						    <option value="<%=rs("jobtype")%>"><%=rs("jobtype")%></option>
                      ...
                      <tr bgcolor="#EDF6FF"> 
                        ...
                        <td width="81%" valign="top" height="22"> <font color="#FF6600">
                          <input id=carload name=contact value="<%=session("Phone")%>" readonly>
                          </font></td>
                      </tr>
                      <tr bgcolor="#EDF6FF">
