  ...
  <tr> 
    ...
    <td align="center" valign="top"> 
      <table width="96%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td background="images/skin3_15.jpg" width="167" height="27" align="center"><font 
                        color=#ffffff><b>产品展示</b></font></td>
          <td>&nbsp;</td>
        </tr>
      </table>
      ...
      <TABLE height=96 cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY> 
        <TR> 
          <TD height=96 align="center"><BR>
            <table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td background="images/skin3_15.jpg" width="167" height="27" align="center"><font 
                        color=#ffffff><b>公司简介</b></font></td>
                <td>&nbsp;</td>
              </tr>
            </table>
            <table width="96%" border="0" cellspacing="1" cellpadding="0" bgcolor="239687">
                  ...
                  <table height=96 cellspacing=0 cellpadding=0 width="100%" border=0>
                    ...
                    <tr> 
                      <td height=96> 
                        ...
                        width="100%" align=center border=0 style="width=800;WORD-WRAP: break-word;word-break: break-all">
                          <tbody> 
                          <tr> 
                            <td height=85> 
                              <p> 
