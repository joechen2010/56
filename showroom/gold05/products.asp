      ...
      background=images/img_bg_31.gif border=0>
        ...
        <tr> 
          <td width="4%" height=29><img height=29 src="images/img_30.gif" 
            width=13></td>
          <td class=font14 width="92%"><strong>产品展示</strong></td>
...
maxpage=10	
 ...
 %>
		...
		%>
                      ...
                      <td width="20%" align="center" bgcolor="<%=bgcolor%>"><%=rs("Num")%></td>
                      <td width="20%" align="center" bgcolor="<%=bgcolor%>"><%=rs("NowPlace")%></td>
                      <td width="20%" align="center" bgcolor="<%=bgcolor%>"><%=rs("AddTime")%></td>
                    </tr>
                    <%
           rs.movenext
       next
