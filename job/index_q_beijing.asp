...
<table width="778" border="0" cellpadding="0" cellspacing="1" bgcolor="#FF6600" align="center">
  ...
  <tr bgcolor="#FF6600"> 
    <td width="66%" height="26" class="text"><font color="#FFFFFF">招聘求职</font></td>
...
strUnit="个信息"
    ...
    sql="select * from zp_info a,qyml b where infotype='求职信息' and a.gsid=b.user and a.city='北京' order by infoid desc"
	sfilename="index.asp"
