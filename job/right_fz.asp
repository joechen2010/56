...
<%
    ...
    sql1="select top 10 * from zp_info a,qyml b where 1=1"&fz&" and infotype='招聘信息' and a.gsid=b.user order by infoid desc"
...
<table width="500" border="0" align="center" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top">
<table cellspacing="0" cellpadding="4" align="Center" rules="all" bordercolor="#3366CC" border="1" id="DataGrid1" style="background-color:White;border-color:#3366CC;border-width:1px;border-style:None;font-size:X-Small;border-collapse:collapse;" width="514">
    <tr align="Center" style="color:#CCCCFF;background-color:#003399;font-weight:bold;">		
...
<%
    ...
    sql="select top 10 * from zp_info a,qyml b where 1=1"&fz&" and infotype='求职信息' and a.gsid=b.user order by infoid desc"
