...
<table width="310" height="136" border=0 align=center cellpadding=0 cellspacing=0 id=Table1 bgcolor="#CCCCCC">
	  <form method="POST" action="infocenter_search.asp" name="form1" target="main">
                      <tr> 
                        <td align="center">
						我要查找：
						  <select name="type_search">
		<option value="1">两地所有单向信息</option>
