...
<table cellspacing="0" cellpadding="2" rules="cols" width="100%" bordercolor="#DEDFDE" border="1" align="center">
  <tr align="Center">
    <td height="25" colspan="7">既时货源信息</td>
  </tr>
  <tr>
    <td height="25" colspan="7">[货源信息]</td>
  </tr>
...
strUnit="个信息"
    ...
    sql="select top 15 * from info2 where infotype='货源信息' order by addtime desc"
	sfilename="infocenter_goods.asp"
...
%>  
  ...
  <tr align="Center" style="background-color:#F7F7DE;"> 
	...
	<%if rs("infotype")="车源信息" then %>
	  ...
	  <%end if%>    </td>
    <td align="Right"> 
      <div align="center"><%=rs("city")%>&nbsp;<%=rs("area")%>→</div>    </td>
    <td align="Left"> 
      <div align="center"><%=rs("city2")%>&nbsp;<%=rs("area2")%></div>    </td>
    <td> 
      <div align="center"><%=rs("cartype")%></div>    </td>
    <td style="font-family:宋体;"> 
      <div align="center"><%=rs("carload")%>吨</div>    </td>
    <td> 
      <div align="center"><%=rs("addtime")%></div>    </td>
    <td> 
      <div align="center"><A href="javascript:openwindow('../truck/detail.asp?InfoID=<%=rs("InfoID")%>',800,400)">详情</A></div>    </td>
  </tr>
