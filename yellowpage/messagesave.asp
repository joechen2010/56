          ...
          <td align="center" valign="top"><table width="534" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td valign="middle" background="../Member/images/title_2.jpg" bgcolor="#FFFFFF" >
                        <div align="center"><font color="#FFFFFF">修改公司资料</font></div>                      </td>
            ...
            <table width="534"  border="0" cellpadding="5" cellspacing="1" bgcolor="1E3E93">
			  ...
			  <table width="100%"  border="0">
                  ...
                  <p align=center><a href="javascript:window.history.back()">返回</a></p></td>
            </tr>
          </table>
                        <table width="534"  border="0" cellspacing="0" cellpadding="5">
              <tr>
                <td align="right"><a href="#top"><img src="../Member/images/icon_top.gif" alt="回到页面顶部" border="0" align="absmiddle" width="15" height="18"></a> 
...
<!--#include file="../Member/bottom.htm"-->
</body>
</html>
