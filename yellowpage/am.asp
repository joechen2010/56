  ...
  <tr> 
    <td align="center" width="52%" valign="top"> 
      <table width="99%" border="0" cellspacing="1" cellpadding="0" bgcolor="#FF9900" align="left">
        ...
        <tr>
          <td bgcolor="#FFFFFF" height="396"><img src="images/139.gif" width="520" height="360"  border="0" usemap="#Map"></td>
        </tr>
      </table>
...
<map name=Map> 
  <area shape=rect alt=路环岛 coords=229,300,271,315 href=am.asp?city=%C2%B7%BB%B7%B5%BA title="路环岛" >
  <area shape=rect coords=220,188,262,204 href=am.asp >
  <area shape=rect alt=澳门半岛 coords=184,73,228,88 href=am.asp?city=%B0%C4%C3%C5%B0%EB%B5%BA title="澳门半岛" >
</map>
