  ...
  <tr> 
    <td align="center" width="52%" valign="top"> 
      <table width="99%" border="0" cellspacing="1" cellpadding="0" bgcolor="#FF9900" align="left">
        ...
        <tr>
          <td bgcolor="#FFFFFF" height="396"><img src="images/115.gif" width="520" height="360"  border="0" usemap="#Map"></td>
        </tr>
      </table>
...
<map name=Map>
	<area shape=rect coords=347,216,404,235      href="hubei.asp?city=武汉"  alt=武汉>
	<area shape=rect coords=282,219,336,236      href="hubei.asp?city=天门" alt=天门>
	<area shape=rect coords=317,243,373,260      href="hubei.asp?city=仙桃" alt=仙桃>
	<area shape=rect coords=252,174,313,195      href="hubei.asp?city=荆门"  alt=荆门>
	<area shape=rect coords=382,227,430,248      href="hubei.asp?city=鄂州"  alt=鄂州>
	<area shape=rect coords=341,279,398,294      href="hubei.asp?city=咸宁"  alt=咸宁>
	<area shape=rect coords=123,82,181,101       href="hubei.asp?city=十堰" alt=十堰>
	<area shape=rect coords=391,165,449,186      href="hubei.asp?city=黄冈"  alt=黄冈>
	<area shape=rect coords=321,166,375,184      href="hubei.asp?city=孝感" alt=孝感>
	<area shape=rect coords=393,262,452,279      href="hubei.asp?city=黄石"  alt=黄石>
	<area shape=rect coords=212,117,276,136      href="hubei.asp?city=襄樊" alt=襄樊>
	<area shape=rect coords=295,123,354,144      href="hubei.asp?city=随州"  alt=随州>	
	<area shape=rect coords=160,198,221,218      href="hubei.asp?city=宜昌"  alt=宜昌>
	<area shape=rect coords=36,243,176,261       href="hubei.asp?city=恩施"  alt=恩施>
	<area shape=rect coords=253,265,303,280      href="hubei.asp?city=荆州"  alt=荆州>
	<area shape=rect coords=258,244,314,261      href="hubei.asp?city=潜江" alt=潜江>
</map>
