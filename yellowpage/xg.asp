  ...
  <tr> 
    <td align="center" width="52%" valign="top"> 
      <table width="99%" border="0" cellspacing="1" cellpadding="0" bgcolor="#FF9900" align="left">
        ...
        <tr>
          <td bgcolor="#FFFFFF" height="396"><img src="images/138.gif" width="520" height="360"  border="0" usemap="#Map"></td>
        </tr>
      </table>
...
<map name=Map> 
  <area shape=rect alt=香港岛 coords=287,267,327,282 href=xg.asp?city=%CF%E3%B8%DB%B5%BA title="香港岛" >
  <area shape=rect alt=离岛 coords=98,269,139,285 href=xg.asp?city=%C0%EB%B5%BA title="离岛" >
	
  <area shape=rect alt=九龙 coords=303,195,342,213 href=xg.asp?city=%BE%C5%C1%FA title="九龙" >
  <area shape=rect alt=新界 coords=208,117,249,133 href=xg.asp?city=%D0%C2%BD%E7 title="新界" >
</map>
