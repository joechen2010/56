    ...
    <td width="19%"> 
      <table cellspacing=0 cellpadding=0 width="100%" border=0>
        <tr> 
          ...
          height=30><strong>招聘信息</strong></td>
      ...
      border=0>
          ...
          valign=top bgcolor=#ffffff height=100> 
                        ...
                        <table cellspacing=1 cellpadding=4 border=0 width="100%" bordercolor="#DEDFDE">
                          <tr align="center" style="color:White;background-color:#6B696B;font-weight:bold;">
                            <td width="15%" align="center">招聘职位</td>
                            <td align="center" width="15%">提供月薪</td>
                            <td align="center" width="40%">职位说明</td>
                            <td width="20%" align="center">发布时间</td>
                            <td width="10%"><strong><font color="#000000">详情</font></strong></td>
                          </tr>
                          <%
    const MaxPerPage=20
   	dim totalPut   
...
strUnit="个信息"
sfilename="zp.asp?infoid="&request("infoid")&"&user="&request("user")&""						
    sql="select * from zp_info where gsid='"+request("user")+"' and (infotype='招聘信息' or infotype='求职信息') order by AddTime desc"
	    Set rs= Server.CreateObject("ADODB.Recordset")
	rs.open sql,conn,1,1
  	if rs.eof and rs.bof then
       		response.write "<tr align=""center"" bgcolor=""#FFDBBF""><td colspan=""7"" > 还 没 有 任 何 信 息</td></tr> </p>"
   	else
...
%>
                          ...
                          <tr align="Center" style="color:#003399;background-color:White;">	
                            <td align="center" width="15%"><%=rs("job")%></td>
                            <td align="center" width="15%"><%=rs("money")%></td>
                            <td align="center" width="40%"><%=rs("content")%></td>
                            <td align="center" width="20%"><%=rs("addtime")%></td>
                            <td width="10%"><a href="javascript:openwindow('../job/detail.asp?InfoID=<%=rs("InfoID")%>',800,400)">详情</a></td>
                          </tr>
  <% 
i=i+1
