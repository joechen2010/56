                ...
                <td height=69 valign="top"> 
                  <table cellspacing=0 cellpadding=0 width="97%" align=center border=0>
                    <tr> 
                      ...
                      <td class=righttitlem background=images/img_title_bg_1x30_.gif height=30><b>货运专线</b></td>
...
strUnit="个信息"
sfilename="zx.asp?infoid="&request("infoid")&"&user="&request("user")&""							  
...
%>
                          <%do while not rs.eof%>
   <tr onMouseOver="this.style.backgroundColor='#FAEFE0'" style="CUrs3OR: hand;" onMouseOut="style.backgroundColor='#F9F9F9'" align="center"> 
           <td height=25 width="30%"><%=rs("a.city")%>&nbsp;<%=rs("a.area")%>←→<%=rs("city2")%>&nbsp;<%=rs("area2")%> 
						   ...
						   %>
                            ...
                            <td height=25 width="8%"><a href="javascript:openwindow('../fline/detail.asp?InfoID=<%=rs("InfoID")%>',800,400)">详情</a></td>
