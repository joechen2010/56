...
<table cellspacing="0" cellpadding="2" rules="cols" bordercolor="#DEDFDE" border="1"  align="center" width="500">
...
dim rs2,type_search
	  ...
	  case else 
		...
		sfilename="search.asp?province="&request("province")&"&province2="&request("province2")&"&city="&request("city")&"&city2="&request("city2")&"&type_search="&request("type_search")&""
