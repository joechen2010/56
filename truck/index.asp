  ...
  <tr> 
    <td> 
      <div align="left"> <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="778" height="70">
          ...
          <embed src="images/top6.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="778" height="70">
          </embed>
        </object> </div>
    </td>
  </tr>
...
<table cellspacing=0 cellpadding=0 width=778 align=center border=0>
  <tr> 
    <td width="278" valign="top" bgcolor="#FFFFBF"> <iframe name="left" src="left.asp" height="500" width="100%" frameborder="0" scrolling="no"></iframe></td>
    <td width="500">
	<iframe name="right" src="right.asp" width="100%" frameborder="0" scrolling="no" height="710"></iframe></td>	
  </tr>
</table>
