<TABLE cellSpacing=0 cellPadding=0 width=960 align=center border=0 bgcolor="#FFFFFF">
  <TBODY> 
  <TR> 
    <TD vAlign=center align=middle width=203> 
      <div align="center"><a 
      href="http://www.168hyxxw.com"><img src="images/logo.gif" border=0><br>
      ...
      <table cellspacing=0 cellpadding=0 border=0 width="100%">
        ...
        <tr align=right> 
            ...
            <table height=30 cellspacing=0 cellpadding=0 width=92% border=0>
              ...
              <tr> 
                ...
                align=center bgcolor=#f8f8f8><a 
                  href="truck/index.asp" class=14link><strong><b>找货找车</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          ...
          <td> 
            ...
            href="Member/car_add.asp"><strong><b>发布车源</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            ...
            href="Repairs/index.asp"><strong><b>修理配件</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            <table height=30 cellspacing=0 cellpadding=0 width=95% border=0>
              ...
              <tr> 
                ...
                align=center bgcolor=#f8f8f8 
                style="BORDER-RIGHT: #FF6600 1px solid; BORDER-LEFT: #FF6600 1px solid; BORDER-BOTTOM: #FF6600 1px solid"><a class=14link 
            href="job/index.asp"><strong><b>招聘求职</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            <table height=30 cellspacing=0 cellpadding=0 width=95% border=0>
              ...
              <tr> 
                <td 
                align=center bgcolor=#f8f8f8 
                style="BORDER-RIGHT: #FF6600 1px solid; BORDER-LEFT: #FF6600 1px solid; BORDER-BOTTOM: #FF6600 1px solid"><a href="yellowpage/index.asp"  class=14link><b>物流黄页</b></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
      ...
      <table cellspacing=0 cellpadding=0 border=0 width="100%">
        ...
        <tr align=right> 
          <td height="30"> 
            <table height=24 cellspacing=0 cellpadding=0 width=92% border=0>
              ...
              <tr> 
                ...
                align=center bgcolor=#f8f8f8><a 
                  href="fline/index.asp" class=14link><strong><b>货运专线</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            <table height=24 cellspacing=0 cellpadding=0 width=92% border=0>
              ...
              <tr> 
                ...
                style="BORDER-RIGHT: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-BOTTOM: #cccccc 1px solid"
                align=center bgcolor=#f8f8f8><a 
                  href="pline/index.asp" class=14link ><strong><b>客运专线</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            <table height=24 cellspacing=0 cellpadding=0 width=95% border=0>
              ...
              <tr> 
                ...
                style="BORDER-RIGHT: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-BOTTOM: #cccccc 1px solid"
                align=center bgcolor=#f8f8f8><a class=14link 
            href="cheliang/index.asp"><strong><b>车辆档案</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            ...
            href="info/index.asp"><strong><b>库房信息</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            <table height=24 cellspacing=0 cellpadding=0 width=95% border=0>
              ...
              <tr> 
                ...
                align=center bgcolor=#f8f8f8 
                style="BORDER-RIGHT: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-BOTTOM: #cccccc 1px solid"><a class=14link 
            href="trade/index.asp"><strong><b>供求信息</b></strong></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
          <td> 
            <table height=24 cellspacing=0 cellpadding=0 width=95% border=0>
              ...
              <tr> 
                <td 
                align=center bgcolor=#f8f8f8 
                style="BORDER-RIGHT: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-BOTTOM: #cccccc 1px solid"><a href="map/index.asp"  class=14link><b>网上地图</b></a></td>
              </tr>
              </tbody> 
            </table>
          </td>
