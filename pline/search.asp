...
<table cellspacing="0" cellpadding="4" align="Center" rules="all" bordercolor="#3366CC" border="1" id="DataGrid1" style="background-color:White;border-color:#3366CC;border-width:1px;border-style:None;font-size:X-Small;border-collapse:collapse;" width="500">
    <tr align="Center" style="color:#CCCCFF;background-color:#003399;font-weight:bold;">		
      <td style="width:130px;" width="130">专线名称</td>
      <td width="203">途经(中转)城市</td>
      <td style="width:160px;" width="139">企业名称</td>
      <td style="width:160px;" width="139">发布时间</td>
      <td style="width:30px;" width="125" align="center">专线</td>
	</tr>
<%
    const MaxPerPage=15
   	dim totalPut   
...
strUnit="个信息"
    ...
    sql="select * from zx_info a,qyml b where 1=1"&p&p2&" and infotype='客运专线' and a.gsid=b.user order by infoid desc"
